...
export default function Sidebar() {
    ...
    const checkConnection = () => {
      ...
      if (savedEmail) {
        try {
          ...
          setIsEmailConnected(!!parsed.isConnected);
        } catch (e) {}
      }
    };
  ...
  const menuItems = [
    { 
      label: 'Dashboard', 
      href: '/dashboard', // BURASI DÜZELTİLDİ ('/' yerine '/dashboard' oldu)
      icon: (
    ...
    { 
      ...
      badge: isEmailConnected 
    },
  ];

  return (
    <aside className="w-64 bg-[#0f172a] text-slate-300 min-h-screen p-6 flex flex-col justify-between shrink-0 font-sans">
      <div className="space-y-8">
        {/* LOGO */}
        <div className="flex items-center gap-3 px-2">
          <h1 className="text-2xl font-black tracking-tight text-white">E-Posta AI</h1>
        </div>

        {/* MENÜ LİSTESİ */}
        <nav className="space-y-2">
          {menuItems.map((item) => {
            // Aktif sayfa kontrolü, pathname ile linkin birebir eşleşip eşleşmediğini kontrol eder
